...
const images = [
  ...
  {
    src: '/sports.jpeg',
    description: `Milima Ward MCA Jerusa Aleu Sikuku today morning passed by Mukuyuni Primary School to hand over netball attires to the Mukuyuni Netball Team and also urged them to put more effort into co-curricular activities and academics.
