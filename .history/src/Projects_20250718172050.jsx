...
const images = [
  ...
  {
    src: '',
    description: 'Milima Ward Personal Assistant to the MCA oversaw the receival of last batch of top dressing fertilizer today at the Agriculture Offices in Mukuyuni.He however urged Milima residents to be patient and wait for directives on when they will collect their farm inputs.',
  },
];
