...
const images = [
  ...
  {
    src: '',
    description: 'Milima Ward Personal Assistant to the MCA oversaw the receival of last batch of top dressing fertilizer today at the Agriculture Offices in Mukuyuni.
